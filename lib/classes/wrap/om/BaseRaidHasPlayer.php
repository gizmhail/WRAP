...
/**
 * Base class that represents a row from the 'Raid_has_Player' table.
 *
 * 
 *
 * @package    propel.generator.wrap.om
 */
abstract class BaseRaidHasPlayer extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'RaidHasPlayerPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        RaidHasPlayerPeer
	 */
	...
	/**
	 * The value for the inscription field.
	 * @var        int
	 */
	...
	/**
	 * Get the [inscription] column value.
	 * 
	 * @return     int
	 */
	...
	public function setPlayerIdplayer($v)
	{
		...
		if ($this->player_idplayer !== $v) {
			...
			$this->modifiedColumns[] = RaidHasPlayerPeer::PLAYER_IDPLAYER;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = RaidHasPlayerPeer::STATUS;
		}
	...
	/**
	 * Set the value of [inscription] column.
	 * 
	 * @param      int $v new value
	 * @return     RaidHasPlayer The current object (for fluent API support)
	 */
	public function setInscription($v)
	{
		...
		if ($this->inscription !== $v) {
			$this->inscription = $v;
			$this->modifiedColumns[] = RaidHasPlayerPeer::INSCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->raid_idraid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RaidHasPlayerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				RaidHasPlayerPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RaidHasPlayerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RaidHasPlayerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RaidHasPlayerPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getRaidIdraid(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setRaidIdraid($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RaidHasPlayerPeer::RAID_IDRAID)) $criteria->add(RaidHasPlayerPeer::RAID_IDRAID, $this->raid_idraid);
	...
	{
		$criteria = new Criteria(RaidHasPlayerPeer::DATABASE_NAME);
		$criteria->add(RaidHasPlayerPeer::RAID_IDRAID, $this->raid_idraid);
		$criteria->add(RaidHasPlayerPeer::PLAYER_IDPLAYER, $this->player_idplayer);
	...
	{
		$pks = array();
		$pks[0] = $this->getRaidIdraid();
		$pks[1] = $this->getPlayerIdplayer();
	...
	{
		$this->setRaidIdraid($keys[0]);
		$this->setPlayerIdplayer($keys[1]);
	}
	...
	{
		return (null === $this->getRaidIdraid()) && (null === $this->getPlayerIdplayer());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RaidHasPlayer (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RaidHasPlayer Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RaidHasPlayerPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RaidHasPlayerPeer();
		}
		return self::$peer;
	}
	...
	public function getRaid(PropelPDO $con = null)
	{
		if ($this->aRaid === null && ($this->raid_idraid !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aRaid->addRaidHasPlayers($this);
			 */
		}
		return $this->aRaid;
	}
	...
	public function getPlayer(PropelPDO $con = null)
	{
		if ($this->aPlayer === null && ($this->player_idplayer !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aPlayer->addRaidHasPlayers($this);
			 */
		}
		return $this->aPlayer;
	}
