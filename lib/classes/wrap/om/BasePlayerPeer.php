...
abstract class BasePlayerPeer {
	...
	const CLASS_DEFAULT = 'wrap.Player';
	...
	/** the column name for the PLAYERNAME field */
	const PLAYERNAME = 'Player.PLAYERNAME';

	/** the column name for the TOKENCOUNT field */
	const TOKENCOUNT = 'Player.TOKENCOUNT';

	/** the column name for the GOLDTOKENCOUNT field */
	const GOLDTOKENCOUNT = 'Player.GOLDTOKENCOUNT';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PlayerPeer::PLAYERNAME);
	 ...
	 *
	 * @param      Player $value A Player object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Player $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = PlayerPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + PlayerPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? PlayerPeer::CLASS_DEFAULT : PlayerPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Player or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Player or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the Player table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Player or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Player $obj, $cols = null)
	{
		$columns = array();
